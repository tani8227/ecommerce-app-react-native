...
const productSlice = createSlice({
    ...
    reducers: {
        ...
        searchProduct: (state, action) => {
            console.log("search input :", action.payload);

            if (action.payload) {
                const keyword = action.payload;
                state.inputSearchProduct = state.filterProduct.filter((ele) => {

                    if (ele.category.includes(action.payload) || ele.title.includes(action.payload)) {
                        return ele;
                    }
                }
                )
...
export const { filterProductsByCategory, searchProduct } = productSlice.actions;
